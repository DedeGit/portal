...
export default class ApexCharts {
  ...
  create(ser, opts) {
    ...
    // Handle the data inputted by user and set some of the global variables (for eg, if data is datetime / numeric / categories). Don't calculate the range / min / max at this time
    ...
    if (gl.axisCharts) {
      ...
      if (w.config.xaxis.type !== 'categories') {
